...
CREATE TABLE `enseignement` (
  ...
  CONSTRAINT `enseignement_ibfk_1` FOREIGN KEY (`cours_id`) REFERENCES `cours` (`id`),
  CONSTRAINT `enseignement_ibfk_2` FOREIGN KEY (`professeur_id`) REFERENCES `professeur` (`id`)
...
-- Dump completed on 2025-12-24 18:02:46
